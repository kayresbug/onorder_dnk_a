...
//            sendFCM(order);
    ...
    public void sendFirebaseOrder(String order, String cardname){
    ...
    public void sendOrder() {
        ...
        for (int i = 0; i < order_list.size(); i++) {
            ...
            order = order + order_list.get(i).getName()+" "+order_list.get(i).getCount()+"개 "+order_list.get(i).getPrice()+"" +"\n";
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl("http://15.164.232.164:5000/")
...
//        prevAuthDate = "210126";
        ...
        m_hash.put("DPTID", "AT0292221A".getBytes());                                     // 단말기번호 , 테스트단말번호 DPT0TEST03
